...
const COLUMNS = [
  ...
  },
  {
    title: 'Commerçants',
    links: [
      { label: 'S\'inscrire comme commerçant', href: '/auth/register?type=merchant' },
      ...
      { label: 'Support commerçants', href: '#' },
  ...
  },
  {
    title: 'Entreprises',
    links: [
      { label: 'TABIT B2B', href: '/auth/register?type=enterprise' },
      { label: 'Appels d\'offres', href: '#' },
      { label: 'API & Intégrations', href: '#' },
      { label: 'Partenariats', href: '#' },
      { label: 'Contactez les ventes', href: '#' },
