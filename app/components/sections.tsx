  ...
  return (
    <section id="how" style={{padding:'96px 56px',borderBottom:'1px solid #E8E0CC',background:'#FAFAF7'}}>
      ...
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',border:'1px solid #E8E0CC'}}>
        {steps.map((s,i)=>(
          <div key={s.num} style={{padding:'40px 40px 48px',position:'relative' as const,borderRight:i%2===0?'1px solid #E8E0CC':'none',borderBottom:i<2?'1px solid #E8E0CC':'none',background:'transparent'}}>
