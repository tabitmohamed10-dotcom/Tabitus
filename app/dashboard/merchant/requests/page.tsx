              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3 pt-1">
                  ...
                  <motion.button
                    ...
                    className="flex-1 bg-brand-gradient text-white font-bold py-3 rounded-xl text-sm disabled:opacity-50 shadow-md shadow-orange-500/20 flex items-center justify-center gap-2"
                  >
                    {submitting ? (
                      <>
